...
module diskemu_mm_interconnect_0_id_router_017_default_decode
  #(
  ...
  (output [60 - 55 : 0] default_destination_id,
...
module diskemu_mm_interconnect_0_id_router_017
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    diskemu_mm_interconnect_0_id_router_017_default_decode the_default_decode(
