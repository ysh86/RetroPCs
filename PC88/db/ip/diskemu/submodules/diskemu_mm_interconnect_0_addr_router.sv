...
module diskemu_mm_interconnect_0_addr_router_default_decode
  #(
...
module diskemu_mm_interconnect_0_addr_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD1 = log2ceil(64'h47000 - 64'h46800); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h47000;
    ...
    diskemu_mm_interconnect_0_addr_router_default_decode the_default_decode(
    ...
    // ( 0x46800 .. 0x47000 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 19'h46800   ) begin
            src_channel = 59'b01;
