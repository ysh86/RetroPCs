...
//   output_name:         diskemu_mm_interconnect_0_rsp_xbar_mux_001
//   NUM_INPUTS:          59
...
module diskemu_mm_interconnect_0_rsp_xbar_mux_001
(
    // ----------------------
    // Sinks
    // ----------------------
    ...
    always @* begin
      ...
      lock[35] = sink35_data[59];
      lock[36] = sink36_data[59];
      lock[37] = sink37_data[59];
      lock[38] = sink38_data[59];
      lock[39] = sink39_data[59];
      lock[40] = sink40_data[59];
      lock[41] = sink41_data[59];
      lock[42] = sink42_data[59];
      lock[43] = sink43_data[59];
      lock[44] = sink44_data[59];
      lock[45] = sink45_data[59];
      lock[46] = sink46_data[59];
      lock[47] = sink47_data[59];
      lock[48] = sink48_data[59];
      lock[49] = sink49_data[59];
      lock[50] = sink50_data[59];
      lock[51] = sink51_data[59];
      lock[52] = sink52_data[59];
      lock[53] = sink53_data[59];
      lock[54] = sink54_data[59];
      lock[55] = sink55_data[59];
      lock[56] = sink56_data[59];
      lock[57] = sink57_data[59];
      lock[58] = sink58_data[59];
    end
