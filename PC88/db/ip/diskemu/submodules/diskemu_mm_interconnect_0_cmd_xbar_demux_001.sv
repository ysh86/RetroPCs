...
//   output_name:         diskemu_mm_interconnect_0_cmd_xbar_demux_001
//   ST_DATA_W:           101
//   ST_CHANNEL_W:        59
//   NUM_OUTPUTS:         59
//   VALID_WIDTH:         1
...
module diskemu_mm_interconnect_0_cmd_xbar_demux_001
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [59-1 : 0] src3_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src4_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src5_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src6_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src7_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src8_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src9_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src10_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src11_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src12_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src13_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src14_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src15_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src16_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src17_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src18_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src19_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src20_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src21_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src22_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src23_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src24_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src25_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src26_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src27_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src28_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src29_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src30_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src31_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src32_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src33_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src34_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src35_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src36_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src37_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src38_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src39_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src40_channel, // ST_CHANNEL_W=59
    ...
    output reg [59-1 : 0] src41_channel, // ST_CHANNEL_W=59
    output reg                      src41_startofpacket,
    output reg                      src41_endofpacket,
    input                           src41_ready,

    output reg                      src42_valid,
    output reg [101-1    : 0] src42_data, // ST_DATA_W=101
    output reg [59-1 : 0] src42_channel, // ST_CHANNEL_W=59
    output reg                      src42_startofpacket,
    output reg                      src42_endofpacket,
    input                           src42_ready,

    output reg                      src43_valid,
    output reg [101-1    : 0] src43_data, // ST_DATA_W=101
    output reg [59-1 : 0] src43_channel, // ST_CHANNEL_W=59
    output reg                      src43_startofpacket,
    output reg                      src43_endofpacket,
    input                           src43_ready,

    output reg                      src44_valid,
    output reg [101-1    : 0] src44_data, // ST_DATA_W=101
    output reg [59-1 : 0] src44_channel, // ST_CHANNEL_W=59
    output reg                      src44_startofpacket,
    output reg                      src44_endofpacket,
    input                           src44_ready,

    output reg                      src45_valid,
    output reg [101-1    : 0] src45_data, // ST_DATA_W=101
    output reg [59-1 : 0] src45_channel, // ST_CHANNEL_W=59
    output reg                      src45_startofpacket,
    output reg                      src45_endofpacket,
    input                           src45_ready,

    output reg                      src46_valid,
    output reg [101-1    : 0] src46_data, // ST_DATA_W=101
    output reg [59-1 : 0] src46_channel, // ST_CHANNEL_W=59
    output reg                      src46_startofpacket,
    output reg                      src46_endofpacket,
    input                           src46_ready,

    output reg                      src47_valid,
    output reg [101-1    : 0] src47_data, // ST_DATA_W=101
    output reg [59-1 : 0] src47_channel, // ST_CHANNEL_W=59
    output reg                      src47_startofpacket,
    output reg                      src47_endofpacket,
    input                           src47_ready,

    output reg                      src48_valid,
    output reg [101-1    : 0] src48_data, // ST_DATA_W=101
    output reg [59-1 : 0] src48_channel, // ST_CHANNEL_W=59
    output reg                      src48_startofpacket,
    output reg                      src48_endofpacket,
    input                           src48_ready,

    output reg                      src49_valid,
    output reg [101-1    : 0] src49_data, // ST_DATA_W=101
    output reg [59-1 : 0] src49_channel, // ST_CHANNEL_W=59
    output reg                      src49_startofpacket,
    output reg                      src49_endofpacket,
    input                           src49_ready,

    output reg                      src50_valid,
    output reg [101-1    : 0] src50_data, // ST_DATA_W=101
    output reg [59-1 : 0] src50_channel, // ST_CHANNEL_W=59
    output reg                      src50_startofpacket,
    output reg                      src50_endofpacket,
    input                           src50_ready,

    output reg                      src51_valid,
    output reg [101-1    : 0] src51_data, // ST_DATA_W=101
    output reg [59-1 : 0] src51_channel, // ST_CHANNEL_W=59
    output reg                      src51_startofpacket,
    output reg                      src51_endofpacket,
    input                           src51_ready,

    output reg                      src52_valid,
    output reg [101-1    : 0] src52_data, // ST_DATA_W=101
    output reg [59-1 : 0] src52_channel, // ST_CHANNEL_W=59
    output reg                      src52_startofpacket,
    output reg                      src52_endofpacket,
    input                           src52_ready,

    output reg                      src53_valid,
    output reg [101-1    : 0] src53_data, // ST_DATA_W=101
    output reg [59-1 : 0] src53_channel, // ST_CHANNEL_W=59
    output reg                      src53_startofpacket,
    output reg                      src53_endofpacket,
    input                           src53_ready,

    output reg                      src54_valid,
    output reg [101-1    : 0] src54_data, // ST_DATA_W=101
    output reg [59-1 : 0] src54_channel, // ST_CHANNEL_W=59
    output reg                      src54_startofpacket,
    output reg                      src54_endofpacket,
    input                           src54_ready,

    output reg                      src55_valid,
    output reg [101-1    : 0] src55_data, // ST_DATA_W=101
    output reg [59-1 : 0] src55_channel, // ST_CHANNEL_W=59
    output reg                      src55_startofpacket,
    output reg                      src55_endofpacket,
    input                           src55_ready,

    output reg                      src56_valid,
    output reg [101-1    : 0] src56_data, // ST_DATA_W=101
    output reg [59-1 : 0] src56_channel, // ST_CHANNEL_W=59
    output reg                      src56_startofpacket,
    output reg                      src56_endofpacket,
    input                           src56_ready,

    output reg                      src57_valid,
    output reg [101-1    : 0] src57_data, // ST_DATA_W=101
    output reg [59-1 : 0] src57_channel, // ST_CHANNEL_W=59
    output reg                      src57_startofpacket,
    output reg                      src57_endofpacket,
    input                           src57_ready,

    output reg                      src58_valid,
    output reg [101-1    : 0] src58_data, // ST_DATA_W=101
    output reg [59-1 : 0] src58_channel, // ST_CHANNEL_W=59
